  ...
  return (
    <CalendlyButton 
      ...
      customButtonContent={
        ...
        >
          <span className="text-[13px] md:text-[1.25rem] relative z-10 flex items-center justify-center gap-3 rounded-full bg-black px-5 py-1 md:px-8 md:py-3 lg:text-[1.042vw] font-medium text-white">
            {/* Schedule Meeting */}
