...
const CoreValues = () => {
    ...
    return (
        <section className="bg-[#F5F5F6] mx-h-[1078px]  py-[3.333vw] relative pb-[64px] global-container">
        ...
        {VALUES.map((v, index) => (
            ...
            >
                <div className="relative flex h-full items-center px-0">
                    ...
                    <div
                        className="
                            pointer-events-none absolute left-[10.99vw] top-1/2 z-10 
