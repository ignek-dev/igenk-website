  ...
  return (
    <div className="flex flex-col">
      ...
      <div className="w-5 h-5 lg:w-10 lg:h-10 mb-3 flex items-center space-x-3">
        ...
        <p className="text-p20 md:text-p24 lg:text-[1.667vw] font-semibold text-white whitespace-pre">{title}</p>
      </div>
      ...
      {/* Description */}
      <p className="text-p16 md:text-p14 lg:p16 leading-relaxed text-gray-300">{description}</p>
    </div>
  )
}
