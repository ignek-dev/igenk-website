        ...
        <div className="flex justify-between text-white">
          ...
          >
            <div className="h-full w-full rounded-[27px] bg-black pt-[3.4896vw] pr-[2.5vw] pb-[2.2917vw] pl-[3.333vw] shadow-[0_4px_4px_0_rgba(0,151,158,0.25)]">
              <h2 className="!text-[2.083vw] tracking-[-2%] text-white">{ceoSectionData.heading}</h2>
          ...
          <div className="pointer-events-none absolute right-0 bottom-[0] h-[57.667vw] w-[51.719vw]">
            <div
