...
export default function Webinar() {
  ...
  return (
    <main className="mt-[-1px]">
      {/* Hero */}
      <section className="global-container relative bg-black pt-32 pb-14.5 lg:pt-[7.865vw] lg:pb-[4.427vw] text-white">
        {/* <div className="pointer-events-none absolute inset-0 -z-10 bg-[radial-gradient(800px_circle_at_10%_0%,#0E7BF8_0%,#00979E_40%,transparent_65%)] opacity-25" /> */}
        <div className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between lg:gap-0">
      ...
      <section className="global-container bg-[##F9FAF7] py-7 lg:pt-[3.333vw] lg:pb-[3.333vw] text-black">
        {/* Header part */}
        <div className="flex flex-col gap-4 lg:flex-row lg:justify-between lg:items-baseline-last lg:mb-[1.875vw] lg:gap-0">
          <h2 className="">
        ...
        <div className="w-full mb-5 hover:opacity-95 transition-opacity lg:mb-0">
        ...
        <div className="lg:mb-[2.396vw] lg:mt-[3.333vw]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6.5">
