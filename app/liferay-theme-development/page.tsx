        ...
        <main className="pb-16">
            ...
            <section className="bg-white text-black">
                <div className="mx-auto w-full px-4 md:px-8 [@media(min-width:1440px)]:px-[150px] [@media(min-width:1920px)]:px-[192px] py-[64px] md:py-[64px] lg:py-[64px]">
                    <h2 className="text-5xl sm:text-4xl md:text-5xl font-semibold leading-tight">Our Liferay Theme Development Services</h2>
                    <p className="text-lg text-gray-700 justify-self-center text-[#101012] leading-relaxed mt-4">
                        Our Liferay Front-End Developers craft stunning Liferay Theme that define your portal’s appearance. We utilize fragments, templates, and OOTB portlets in our Liferay Theme Development services. This ensures a seamless and enhanced user experience.
                    </p>
                    <div className="pt-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[38px]">
                            {themeDevelopmentServices.map((item, index) => (
                                <div
                                    key={index}
                                    className="bg-white border border-[#E5E7EB] shadow-md shadow-black rounded-lg p-6 flex flex-col items-center justify-center min-h-[100px]"
                                    style={{
                                        boxShadow: "-10px 10px 0 rgba(0, 0, 0, 1)",
                                    }}
                                >
                                    <p className="text-xl font-medium text-black text-center">{item}</p>
                                </div>
                            ))}
                        </div>
                    </div>
