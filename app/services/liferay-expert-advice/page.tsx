    ...
    <main className="pb-0">
      ...
      <section className="relative bg-black text-white">
        ...
        <div className="global-container mx-auto w-full pt-32 pb-16 lg:pt-12 lg:pb-[3.802vw]">
          <div className="relative grid items-start gap-6 lg:gap-10 lg:grid-cols-2">
            <div>
            ...
            <p className="text-p16! md:text-p18! relative bottom-0 w-full text-left text-gray-300 lg:absolute lg:max-w-[52vw] xl:max-w-[40vw] lg:text-right lg:text-white md:justify-self-end">
          ...
          <div className="mt-10 inline-flex flex-wrap gap-3 lg:mt-[3.177vw] lg:gap-[1.5vw]">
            {featureTabs.map((label) => (
              <span
                key={label}
                className="text-p16! md:text-p18! lg:text-p20-lg! inline-flex items-center rounded-full lg:rounded-[2.083vw] border border-[#374151] bg-black px-5 py-2 lg:px-[1.458vw] lg:py-[0.833vw] text-white shadow-[0_0.208vw_0.521vw_0_rgba(0,151,158,0.25)] transition-colors"
              >
                {label}
              </span>
            ))}
      ...
      <section className="bg-white text-black">
        <div className="global-container mx-auto w-full py-16 lg:py-[3.333vw]">
          <div className="flex flex-col items-start lg:flex-row gap-10 lg:gap-[8.75vw]">
            ...
            <div className="w-full space-y-6 pt-2 lg:space-y-[1.979vw] lg:pt-[0.417vw] md:justify-self-end">
      ...
      <section className="global-container bg-black py-16 lg:py-[3.333vw] text-white">
        <div className="flex w-full flex-col  items-start gap-10 lg:flex-row lg:gap-[10.573vw]">
          {/* Left Column */}
          <div className="static flex flex-col gap-4 lg:sticky lg:top-[10.417vw] lg:gap-[1.458vw]">
            <h2 className="w-full lg:w-[33.073vw] text-white">{expertAdviceSolutions.heading}</h2>
            <p className="text-p16 md:text-p18 text-gray-100">
                ...
                >
                  ...
                  <div className="pt-6 pb-12 lg:pt-[1.5vw] lg:pb-[4vw]">
                    <div className="flex items-baseline gap-4 lg:gap-[3.438vw]">
                      <span className="text-2xl font-normal text-white lg:text-[1.563vw] lg:leading-[3.125vw]">({item.number})</span>
                      <div className="flex flex-col gap-3 lg:gap-[1.458vw]">
                        <h3 className="w-full lg:w-[22.76vw] text-[1.563vw] leading-[1.875vw] font-normal text-white">
                          {item.title}
                        </h3>
