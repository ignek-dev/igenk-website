    ...
    <main className="mt-[-1px]">
      ...
      <section className="global-container relative bg-black pt-[7.865vw] pb-[4.427vw] text-white">
        ...
        <div className="flex items-end justify-between">
          ...
          <p className="w-[31.479vw] text-right text-[0.938vw] leading-[1.458vw]">
            Stay informed with our latest webinars covering emerging trends, software solutions, and industry best
            practices. Watch live or catch up on past sessions anytime. Register now to enhance your knowledge and
            ...
            >
              ...
              <div className="relative w-full bg-black">
                <Image
                  ...
                  height={254}
                  width={400}
                  className="object-contain max-h-[254px] h-full w-full"
                />
              </div>

              {/* MIDDLE: Dynamic Content */}
              <div className="p-[1.25vw] flex flex-col flex-grow bg-white">
                
                {/* Title */}
                <h4 className="text-[1.1vw] font-bold text-gray-900 leading-tight mb-[0.729vw]">
                  {webinar.title}
                </h4>

                {/* Details List (Spacing set to 14px approx 0.729vw) */}
                <div className="flex flex-col gap-[0.729vw] text-[0.833vw] text-gray-600 mb-[1.5vw] flex-grow">
                  
                  {/* Location */}
                  <div className="flex items-start gap-3">
                    <svg className="w-4 h-4 mt-0.5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 5.25 7 13 7 13s7-7.75 7-13c0-3.87-3.13-7-7-7zm0 9.5c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5z"/></svg>
                    <span>{webinar.location}</span>
                  </div>
                  
                  {/* Date */}
                  <div className="flex items-start gap-3">
                     <svg className="w-4 h-4 mt-0.5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M19 3h-1V1h-2v2H8V1H6v2H5c-1.11 0-1.99.9-1.99 2L3 19c0 1.1.89 2 2 2h14c1.1 0 2-.9 2-2V5c0-1.1-.9-2-2-2zm0 16H5V8h14v11zM7 10h5v5H7z"/></svg>
                    <span>{webinar.date}</span>
                  </div>

                  {/* Time */}
                  <div className="flex items-start gap-3">
                    <svg className="w-4 h-4 mt-0.5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z"/></svg>
                    <span>{webinar.time}</span>
                  </div>

                  {/* Cost */}
                  <div className="flex items-start gap-3">
                     <svg className="w-4 h-4 mt-0.5 text-gray-500" fill="currentColor" viewBox="0 0 24 24"><path d="M21.41 11.58l-9-9C12.05 2.22 11.55 2 11 2H4c-1.1 0-2 .9-2 2v7c0 .55.22 1.05.59 1.42l9 9c.36.36.86.58 1.41.58.55 0 1.05-.22 1.41-.59l7-7c.37-.36.59-.86.59-1.41 0-.55-.23-1.06-.59-1.42zM5.5 7C4.67 7 4 6.33 4 5.5S4.67 4 5.5 4 7 4.67 7 5.5 6.33 7 5.5 7z"/></svg>
                    <span className="uppercase font-semibold text-gray-600">{webinar.cost}</span>
                  </div>
                </div>
                ...
                <Link
                  href={webinar.link}
                  className="block w-full text-center bg-black text-white py-[0.729vw] rounded-lg font-medium hover:bg-gray-800 transition-colors"
                >
                  Register Now
                </Link>
              </div>
