  ...
  return (
    <main className="pb-0" >
      ...
      <section className="relative bg-black text-white">
        ...
        <div className="mx-auto w-full px-5 py-14.5 lg:px-4 lg:pt-[7.8125vw] lg:pb-[4.427vw] global-container">
          <div className="relative flex flex-col gap-4 lg:grid lg:grid-cols-2 lg:items-end lg:justify-between lg:gap-[2.083vw]">
      ...
      <div className="bg-[#F9FAF7] px-4 py-7 lg:pt-[1.875vw] lg:px-[4.323vw] lg:pb-[4.094vw]">
