        ...
        <main className="pb-16">
            ...
            <section className="bg-[#f7f7f7] text-black">
                <div className="mx-auto w-full px-4 md:px-8 [@media(min-width:1440px)]:px-[150px] [@media(min-width:1920px)]:px-[192px] py-[64px] md:py-[64px] lg:py-[64px]">
                    ...
                    <div className="pt-8">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[60px]">
                            {liferayPOCServices.map((item, index) => (
                                <div
                                    key={index}
                                    className="bg-white border border-[#E5E7EB] rounded-full flex h-[80px]"
                                >
                                    ...
                                    <p className="text-xl font-medium text-black text-left p-3 pr-0 w-[80%]">{item}</p>
                                </div>
                            ))}
                        </div>
                    </div>
