...
export default function LiferayUpgradePage() {
    ...
    return (
        <main className="pb-16">
                        ...
                        <div className="w-full overflow-x-auto">
                            <div className="flex relative min-w-max">
                                {dynamicSteps.map((step, index) => (
                                    <div key={index} className="flex flex-col items-center relative flex-shrink-0 w-1/11">
                                        {/* Number */}
                                        <div className="w-12 h-12 flex items-center justify-center bg-black text-white rounded-full font-medium text-lg z-10">
                                            {step.number}
                                        </div>

                                        {/* Text */}
                                        <p className="mt-2 text-center text-black text-3xl font-medium w-[80%]">
                                            {step.title}
                                        </p>
                                        ...
                                        {index < dynamicSteps.length - 1 && (
                                            <div
                                                className="absolute top-6 right-0 h-1.5 bg-gray-200 z-0"
            ...
            <section className="bg-white text-black py-20 lg:py-24">
                <div className=" mx-auto w-full px-4 md:px-8 [@media(min-width:1440px)]:px-[150px] [@media(min-width:1920px)]:px-[192px]  items-start">
                    <div className="grid items-start gap-10 md:grid-cols-2 relative">
                        <h2 className="text-3xl font-semibold sm:text-4xl md:text-5xl">Liferay DXP 7.4 Upgrade Process : A Complete Guide</h2>
            ...
            <section className="bg-white text-black py-20 lg:py-24">
                <div className=" mx-auto w-full px-4 md:px-8 [@media(min-width:1440px)]:px-[150px] [@media(min-width:1920px)]:px-[192px]  items-start">
                    <div className="grid items-start gap-10 md:grid-cols-2 relative">
                        <h2 className="text-3xl font-semibold sm:text-4xl md:text-5xl">Why Choose IGNEK For Liferay DXP 7.4 Upgrade Services?</h2>
                        <p className="max-w-xl md:justify-self-end absolute bottom-0 text-lg text-gray-700 text-right">
