...
export const homepageData = {
  hero: {
    ...
    button: {
      text: "Discover More",
      icon: "/images/icon/discover-arrow.png",
      link: "#discover",
    },
  },
}
  ...
  platforms: [
    {
      ...
      hoverDescription:
        "Liferay is a Digital Experience Platform (DXP) that enables organizations to build and manage digital experiences across various channels. It provides tools for creating and managing websites, portals, intranets, and more. Liferay is known for its flexibility, scalability, and open-source nature.",
    },
  ],
}
...
export const whatWeBringHeader = {
...
export const ratingsData = [
  { id:1, logoSrc: "/images/ratings/google_logo.webp", logoAlt: "Google", ratingValue: "4.9" },
  { id:2, logoSrc: "/images/ratings/upwork-logo.svg.png", logoAlt: "Upwork", ratingValue: "5.0" },
  { id:3, logoSrc: "/images/ratings/clutch-logo.png", logoAlt: "Clutch", ratingValue: "5.0" },
  { id:4,logoSrc: "/images/ratings/ambition.png", logoAlt: "Ambition", ratingValue: "5.0" },
]
